...
namespace Assets.Scripts.Common
{
    ...
    public class MonoSingleton<T> : MonoBehaviour where T : Component
    {
        ...
        public static T GetInstance()
        {
            if(_instance == null)
            {
                GameObject root = GameObject.Find("BootRoot");
                if(root == null)
                {
                    root = new GameObject("BootRoot");
                    Util.DontDestroyOnLoadWrapper(root);
                }
                ...
                DebugHelper.Log(typeName + "Created From Script!!!");
            }
        ...
        protected virtual void Awake()
        {
            ...
            {
                Util.DontDestroyOnLoadWrapper(this.gameObject);
                _instance = this;
