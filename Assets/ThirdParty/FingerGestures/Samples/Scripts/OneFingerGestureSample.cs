...
- Swipe: press the yellow sphere and move your finger in one of the four cardinal directions, then release. The moveSpeed of the motion is taken into account.";
    }
