...
public class MultiFingerSwipeSample : SampleBase
{
    ...
    {
        return @"Swipe: press the yellow sphere with " + swipeGesture.RequiredFingerCount + " fingers and move them in one of the four cardinal directions, then release. The moveSpeed of the motion is taken into account.";
    }
